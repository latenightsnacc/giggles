...
function App() {
  return (
    <div className="bg-white bg-center  h-screen flex items-center justify-center bg-contain bg-no-repeat" style={{backgroundImage: `url(${bgImg})`, transform:"rotate(270deg)"}}>
