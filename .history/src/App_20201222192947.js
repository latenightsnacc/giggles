...
class App extends Component {
  render() {
    return (
      <div className="wrapper min-h-screen overflow-y:scroll w-full flex flex-col justify-center items-center" style={{background:`linear-gradient(to right, blue 50%, #fff 50%)`}}>
          <div className="w-5/6">
